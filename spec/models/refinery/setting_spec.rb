...
module Refinery
  describe Setting do
    ...
    context "set" do
      ...
      let(:creating_from_scratch) {
        ::Refinery::Setting.find_by(name: 'creating_from_scratch', scoping: 'rspec_testing')
      }
      it "should default to form_value_type text_area" do
        set = ::Refinery::Setting.set(:creating_from_scratch, {:value => "a value", :scoping => 'rspec_testing'})
        creating_from_scratch.form_value_type.should eq("text_area")
      end
      ...
      it "should fix true as a value to 'true' (string)" do
        ...
        creating_from_scratch[:value].should eq('true')
        set.should eq(true)
      end
      ...
      it "should fix false as a value to 'false' (string)" do
        ...
        creating_from_scratch[:value].should eq('false')
        set.should eq(false)
      end
